...
namespace PropertyApp
{
    public partial class MainPage : ContentPage
    {
        ...
        public List<Property> GetProperties()
        {
            ...
            {
                new Property { Image = "apt1.png", Address = "2162 Patricia Ave, LA", Location = "Califonia", Price = "$1500/mo", 
                    Bed = "4 Bed", Bath = "3 Bath", Space = "1600 sqft", 
        ...
        private void ChangeTextColor(View child, string color)
        {
            var txtChild = child.FindByName<Label>("PropertyTypeName");
            if(txtChild != null)
            {
                txtChild.TextColor = Color.FromHex(color);
            }
        }
    }
    ...
    {
        public string Id => Guid.NewGuid().ToString("id");
